...
def chk():
  ...
  try:
    httpCaht = requests.get("https://github.com/Luffyomala/pahq.txt/blob/main/Kaml.txt").text
    if id not in httpCaht:
      print("\033[92mYOUR ID IS ACTIVE.........")
      msg = str(os.geteuid())
      time.sleep(1)
      pass
    else:
      print("\x1b[91mBarezm Id kat active nya Tkaya bo Active krdn nama bnera bo telegram @X6_1M ")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
\033[36;1m----------------------------------------------------
\033[32;1mCREATOR : \033[0;1m Note 5$
\033[32;1mTELEGRAM : \033[0;1m https://t.me/im_xof_crak
\033[32;1mVERSION : \033[0;1m OWNER TOOL "' @X6_1M : @IM_XOF\033[36;1m----------------------------------------------------
"""
#---------------------
